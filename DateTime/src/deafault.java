...
public class deafault {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Duration t144 = Duration.between(PastWeek.atTime(0,0), d04.atTime(0,0));
		Duration t1 = Duration.between(PastWeek.atStartOfDay(), d04.atStartOfDay());
		Duration t2 = Duration.between(PastWeekT, d05);
		Duration t3 = Duration.between(PastWeekI, d06);
		...
		System.out.println("semana passaada: "+PastWeekI);
		System.out.println("Semana que vem: "+NextWeekI);
